...
// itall sidecar plugin is present. Generated by
// `packages/eslint-plugin-itall-react/scripts/generate-itall-registry.mjs`
// — re-export rather than redefine so the sidecar package stays the
// single source of truth for rule keys + default severities + capability/tag
// metadata.
export {
  ITALL_REACT_RULES,
  ITALL_REACT_RULE_METADATA,
  type ItallReactRuleMetadata,
} from "./itall-rules.gen.js";
